...
| pnpmVersion | pnpm version. Installed by downloading the official pnpm/pnpm GitHub-release binary directly to /usr/local/bin/pnpm. Use 'latest' for the newest, or pin (e.g. '11.2.2'). | string | latest |
