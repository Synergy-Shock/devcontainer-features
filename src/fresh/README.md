...
# Fresh (Terminal IDE) (fresh)

Installs the Fresh terminal text editor / IDE from the official sinelaw/fresh GitHub release as a static musl prebuilt binary. Assumes 'ghcr.io/devcontainers/features/common-utils:2' has run.
...
|-----|-----|-----|-----|
| version | Fresh version. 'latest' (default) resolves the newest GitHub release, or pin an exact version ('0.4.1' / 'v0.4.1'). | string | latest |
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/Synergy-Shock/devcontainer-features/blob/main/src/fresh/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
